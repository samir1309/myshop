												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{URL::action('Admin\UserController@getEdit',[$row->id])}}"
                                                                   data-toggle="tooltip" data-original-title="ویرایش اطلاعات"
                                                                   class="btn btn-space  btn-warning"><i class="fa fa-edit"></i> ویرایش </a>
                                                            <a href="" type="button" class="btn btn-primary text-white" data-toggle="modal" data-target="#exampleModal1{{$row->id}}" >پسورد</a>
...
@foreach($data as $row2)
    <div class="modal fade" id="exampleModal1{{$row2->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>رمز:</label>
                                    <input class="form-control" type="password" id="password" value="@if(isset($row2->password)){{$row2->password}}@endif" name="password"
                                           placeholder="رمز عبور">
                                </div>
                                <div class="col-md-12">
                                    <label>تکرار رمز:</label>
                                    <input class="form-control" type="password" value="@if(isset($row2->password)){{$row2->password}}@endif" id="repassword" name="repassword"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary text-light">ذخیره</button>
                    </div>
                </form>
            </div>
        </div>
