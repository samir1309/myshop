    ...
    <div class="container-fluid dashboard-content">
        <div class="row w-100 m-0">
            <div class="col-lg-12 mx-auto py-1 px-0">
                ...
                <form method="post" 	action="{{ route('admin.setting.edit', $data->id) }}"
...
<div class="row">
	...
	<div class="col-lg-6 form-group">
		<label for="aboutshort" class="col-form-label">عنوان درباره ما</label>
		<input id="aboutshort" name="aboutshort" type="text" class="form-control"
			value="@if(isset($data->aboutshort)){{$data->aboutshort}}@endif">
	</div>
    ...
    <div class="col-lg-6 form-group">
        ...
        @if(isset($data->logo))
            <img src="{{asset('assets/uploads/setting/'.$data->logo)}}" class="w-50">
        @endif
    </div>
    <div class="col-lg-6 form-group">
        ...
        @if(isset($data->favicon))
            <img src="{{asset('assets/uploads/setting/'.$data->favicon)}}" class="w-50">
        @endif
    </div>
    <div class="col-lg-6 form-group">
    ...
    <div class="col-lg-6 form-group">
        ...
        @if(isset($data->banner2))
            <img src="{{asset('assets/uploads/setting/'.$data->banner2)}}" class="w-50">
        @endif
    </div>
    ...
    <div class="form-group">
        ...
        <a href="" target="_blank" type="button" data-toggle="tooltip" title="مشاهده در سایت"
