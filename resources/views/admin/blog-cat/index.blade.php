...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
{{--		<form method="post" action="{{url('/admin/blog-cat/delete')}}">--}}
{{--			{{ csrf_field() }}--}}
			<div class="py-3 px-2">
...
{{--					حذف انتخاب شده ها--}}
{{--				</button>--}}
				<a href="{{url('admin/blog-cat/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
									...
									<div class="row w-100 m-0">
										<div class="col-sm-12">
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													@foreach($category as $key=> $article)
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('Admin\BlogCategoryController@getEditArticleCat',$article->id)}}"
																type="button"
...
{{--                        $.post("{!!URL::action('')!!} ", order, function (theResponse) {--}}
