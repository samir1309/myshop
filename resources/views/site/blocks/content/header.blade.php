	...
	<div class="pb-4 d-flex">
		<div class="row w-100 m-0">
			<div class="col-md-12 p-0 px-sm-0 py-sm-0">
				<div class="row w-100 m-0">
					<!-- desktop -->
					<div class="col-xxl-12 py-0 px-0 p-xs-0 d-md-block d-none">
								...
								<div class="carousel-inner h-100">
									...
									<div class="carousel-item @if($key == 0)active @endif">
										<a @if($slider->link != null) href= "{{@$slider->link}}" rel="noopener
											...
											@endif>
											<img srcset="{{asset('assets/uploads/content/sli/'.@$slider->image)}}"  src="{{asset('assets/uploads/content/sli/'.@$slider->image)}}" class="d-block text-secondary text-center h2 m-0"  width="100%" height="100%" alt="{!! @$slider->title !!}">
										</a>
									</div>
									@endforeach
					...
					<!-- mobile -->
					<div class="col-xxl-12 py-0 px-0 p-xs-0 d-md-none d-block">
						<div class="card rounded-0 border-0 p-0">
							<div id="kajshopCarousel" class="carousel slide carousel-fade"
								data-bs-ride="carousel" data-bs-interval="3000">
								...
								<div class="carousel-inner h-100">
									...
									<div class="carousel-item @if($key == 0)active @endif">
										<a @if($mobile_slider->link != null) href= "{{@$mobile_slider->link}}" rel="noopener noreferrer nofollow" @else href="{{route('site.banner.detail',['id'=>@$mobile_slider['id']])}}" @endif>
											<img srcset="{{asset('assets/uploads/content/sli/'.@$mobile_slider->image)}} 2x, {{asset('assets/uploads/content/sli/'.@$mobile_slider->image)}} 1x" loading="lazy" src="{{asset('assets/uploads/content/sli/'.@$mobile_slider->image)}}" class="d-block text-secondary text-center h2 m-0" width="100%" height="100%" alt="{!! @$mobile_slider->title !!}">
										</a>
									</div>
									@endforeach
									<!-- <a href="" class="carousel-item h-100 active" style="background-image: url('assets/site/images/c1.jpg');"></a> -->
