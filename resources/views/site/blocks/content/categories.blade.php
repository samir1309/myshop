        ...
        @foreach($categories as $category)
            <div class="col-xxl col-md col-sm-6 col-xs-6 text-center mx-auto p-1">
                <a href="{{route('site.product.list',['id'=>$category->id])}}">
                    <div class="card border-0 rounded-0 shadow-sm bg-transparent">
                        <figure class="m-0">
                            <div class="figure-inn">
                                <img loading="lazy" src="{{$category->cat_image}}" alt="{!! $category->title !!}" width="100%" height="100%" />
                            </div>
                        </figure>
                        <p class="h6 my-0 py-3 bg-transparent text-center">
                            {!! $category->title !!}
                        </p>
                    </div>
                </a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-4 p-2">
                <a href="{{route('site.product.list',['id'=>$category->id])}}" class="d-flex w-100 h-100">
                    <div class="card rounded-0 p-2 w-100">
                        <div>
                            <img  src="{{$category->cat_image}}" alt="{!! $category->title !!}"
