...
<section class="bg-light py-0 py-sm-5">
	<div class="container">
		<div class="row py-5">
			<div class="col-lg-8">
				<!-- Badge -->
				<h6 class="mb-3 font-base bg-primary text-white py-2 px-4 rounded-2 d-inline-block">{{$categories}}
</h6>
				<!-- Title -->
				...
				<ul class="list-inline mb-0">
					...
					<!-- <li class="list-inline-item me-3 mb-1 mb-sm-0"><i class="bi bi-patch-exclamation-fill text-danger me-2"></i>آخرین بروزرسانی :  {{$course-> updated_at }}</li> -->
					<li class="list-inline-item mb-0"><i class="fas fa-globe text-info me-2"></i>فارسی</li>
				</ul>
			</div>
		</div>
	</div>
