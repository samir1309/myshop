			...
			<div class="col-12">
				<div class="row align-items-center">
					...
					<div class="col-6 col-md-3 text-center order-1">
						<img src="{{asset('assets/site/images/element/category-1.svg')}}" alt="">
					</div>
					...
					<div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
						...
						<!-- Title -->
						<h1 class="mb-3 fs-3">چه چیزی میخواهی یاد بگیری؟</h1>
						<p class="mb-3">با معتبرترین دوره های آنلاین و گواهینامه ها، مهارت خود را افزایش دهید</p>

						<!-- Search -->
						<form class="bg-body rounded p-2">
							<div class="input-group">
								<input class="form-control border-0 me-1" type="search" placeholder="جستجوی دوره ">
								<button type="button" class="btn btn-dark mb-0 rounded">جستجو</button>
							</div>
						</form>
					</div>
					...
					<div class="col-6 col-md-3 text-center order-3">
						<img src="{{ asset('assets/site/images/element/category-2.svg ')}}" alt="">
					</div>
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-3">انتخاب دسته بندی</h2>
			...
			<div class="col-sm-6 col-md-4 col-xl-3">
				<div class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<div class="icon-xl bg-body mx-auto rounded-circle mb-3">
						<img src="{{ asset('assets/site/images/element/data-science.svg')}}" alt="">
					</div>
					<!-- Title -->
					<h5 class="mb-2"><a href="{{ route('site.product.details', $course->url) }}" class="stretched-link">{{$course->title}}</a></h5>
					<h6 class="mb-0 fw-normal">15    {{ $course->title }}</h6>
				</div>
			</div>
            @endforeach
		</div>
