				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							<!-- Title -->
							<img src="{{asset('assets/site/images/element/03.svg')}}" class="h-40px mb-2" alt="">
							<h2 class="">ثبت نام</h2>
							<p class="mb-4">از دیدن شما خوشحالم! لطفا با حساب کاربری خود ثبت نام کنید.</p>
						
							<!-- Form START -->
                            <form class="mb-0 mt-4" method="post" action="{{ route('panel.register') }}" enctype="multipart/form-data">
					            {{ csrf_field() }}
                                <!-- name -->
								<div class="mb-4">
